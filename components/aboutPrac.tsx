...
export default function AboutPrac() {
  ...
  return (
    <section id="about" className="scroll-mt-28 w-full">
      ...
      <div className="flex items-center justify-center py-2">
          {aboutData[index].title === "experience" && <Experience />}
          {aboutData[index].title === "credentials" && <Education />}
          {aboutData[index].title === "skills" && <Skills />}
      </div>
    </section>
  );
}
